...
<body>
    ...
    <div class="form-container">
        ...
        <form class="myForm" id="registrationForm" action="../Tennis_Joint/User_Registration.php" onsubmit="return RegistrationValidation()"  method="POST">
            ...
            <input  placeholder="Phone number" type="number" name="number"  id="number">
            <textarea  placeholder="Address" type="text" name="address"  id="address"></textarea>
            <input  placeholder="Enter password" type="password" name="password1"  id="password1">
            <input  placeholder="Confirm password" type="password" name="password2" id="password2">
            <br>
            <span id="dobHeading">Date of Birth</span>
            <br>
            <select name=DOBday id="selectDOBday">
            ...
            <select name=DOBmonth id="selectDOBmonth">
            ...
            <select name=DOByear id="selectDOByear">
