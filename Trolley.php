    ...
    <div id="content"><!--content  -->
        <div class="container"><!--container  -->
            ...
            <?php
                ...
                $result = mysqli_query($conn, "select distinct theTable from trolley where customerEmail = '$getEmail' and orderStatus='trolley'") or die(mysqli_error($conn));
                $resultCheck = mysqli_num_rows($result);

                $result2 = mysqli_query($conn, "select COUNT(*) from trolley where customerEmail = '$getEmail'") or die(mysqli_error($conn));
            ...
            <div id="trolley" class="col-md-9"><!--Trolley  -->
                ...
                <div class="box"><!--box  -->
                    <form action="Trolley.php" method="post" enctype="multipart/form-data"><!--Form  -->
                        ...
                        <h1>Your Trolley</h1>
                        <p class="text-muted"><?php echo $row3['theTable'] ?> Items in your Trolley</p>
                        <div class="table-responsive"><!--table-responsive  -->
                            ...
                            <table class="table"><!--table  -->
                                ...
                                <?php
                                    ...
                                    if ($resultCheck > 0)
                                    {
                                        ...
                                        {
                                            $sql2 = "SELECT distinct( $value.name), trolley.idProducts, trolley.customerEmail, trolley.quantity, trolley.size, $value.picture, $value.price from trolley INNER JOIN $value on  $value.idProducts=trolley.idProducts inner join users on users.email= trolley.customerEmail where trolley.customerEmail='$getEmail' and trolley.orderStatus='trolley'";
                                                ...
                                                while ($myProducts=mysqli_fetch_array($result2))
                                                {
                                                    ...
                                                    <tbody><!-- tbody details of product in trolley -->
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="removeFromTrolley.php?idProducts='.$myProducts['idProducts'].'"> Delete <i class="fa fa-trash"></i></a>
                                                            </td> 
                                                        </tr>
                            ...
                            <div class="box-footer"><!--box-footer  -->
                                <div class="pull-right"><!-- pull-right -->
                                    <a href="placeOrder.php" class="btn btn-primary">
