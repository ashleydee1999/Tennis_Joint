            ...
            <div id="trolley" class="col-md-9"><!--Trolley  -->
                ...
                <div class="box"><!--box  -->
                    <form action="Trolley.php" method="post" enctype="multipart/form-data"><!--Form  -->
                        ...
                        <h1 class="text-muted" ><?php echo $orderEmail; ?>'s Trolley</h1>
                        <div class="table-responsive"><!--table-responsive  -->
                            ...
                            <table class="table"><!--table  -->
                                ...
                                <?php
                                    ...
                                    $result = mysqli_query($conn, "select distinct theTable from trolley where customerEmail = '$orderEmail'") or die(mysqli_error($conn));
