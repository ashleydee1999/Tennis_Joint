...
<body>
    ...
    <div id="error_messageLogin"></div>
    
    <div class="Loginform-container">
        <h4><i class="fa fa-lock"></i> LOGIN</h4>
        <form method="POST" action="databaseLogin.php" onsubmit="return LoginValidation()" class="myForm">

            <input placeholder="Email address" name="UserEmail" type="email" id="UserEmail">
            <input  placeholder="Enter password" name="UserPassword" type="password"  id="UserPassword">
            <br>
